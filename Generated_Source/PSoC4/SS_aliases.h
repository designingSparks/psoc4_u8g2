...
#define SS_0_PS		(SS__0__PS)
#define SS_0_PC		(SS__0__PC)
#define SS_0_DR		(SS__0__DR)
#define SS_0_SHIFT	(SS__0__SHIFT)
#define SS_0_INTR	((uint16)((uint16)0x0003u << (SS__0__SHIFT*2u)))
