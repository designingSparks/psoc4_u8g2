...
{
    #ifdef UART_RX_ISR_INTERRUPT_INTERRUPT_CALLBACK
        UART_RX_ISR_Interrupt_InterruptCallback();
    #endif /* UART_RX_ISR_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling UART_RX_ISR_Start or UART_RX_ISR_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after UART_RX_ISR_Start or UART_RX_ISR_StartEx has been called. 
