...
#define UART_RX_ISR_INTC_VECTOR            ((reg32 *) UART_RX_ISR__INTC_VECT)

/* Address of the UART_RX_ISR ISR priority. */
#define UART_RX_ISR_INTC_PRIOR             ((reg32 *) UART_RX_ISR__INTC_PRIOR_REG)
...
#define UART_RX_ISR_INTC_SET_EN            ((reg32 *) UART_RX_ISR__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the UART_RX_ISR interrupt. */
#define UART_RX_ISR_INTC_CLR_EN            ((reg32 *) UART_RX_ISR__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the UART_RX_ISR interrupt state to pending. */
#define UART_RX_ISR_INTC_SET_PD            ((reg32 *) UART_RX_ISR__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the UART_RX_ISR interrupt. */
#define UART_RX_ISR_INTC_CLR_PD            ((reg32 *) UART_RX_ISR__INTC_CLR_PD_REG)
